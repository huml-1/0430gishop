        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            <li class="with-x" v-if="this.options.categoryName">
              {{ this.options.categoryName }}<i @click="removeCateName">×</i>
            </li>
        ...
        <div class="details clearfix">
          <div class="sui-navbar">
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li :class="{ active: options.order.split(':')[0] === '1' }" @click="setOrder('1')">
                  <a href="javascript:">
                    综合
                    <i
                      class="iconfont"
                      :class="orderArr[1]==='desc'?'icon-desc':'icon-asc'"
                      v-if="orderArr[0] === '1'"
                    ></i>
                  </a>
                </li>
                <li :class="{ active: options.order.split(':')[0] === '3' }" @click="setOrder('3')">
                  <a href="javascript:">
                      销量
                    <i
                      class="iconfont"
                ...
                <li :class="{ active: options.order.split(':')[0] === '2' }" @click="setOrder('2')">
                   <a href="javascript:">
                      价格
                    <i
                      class="iconfont"
